...
class MakeVolume(object):
    r"""Proxy of C++ ifcopenshell::geometry::settings::MakeVolume class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    name = _ifcopenshell_wrapper.MakeVolume_name
    
    description = _ifcopenshell_wrapper.MakeVolume_description
    
    defaultvalue = _ifcopenshell_wrapper.MakeVolume_defaultvalue
    

    def __init__(self):
        r"""__init__(MakeVolume self) -> MakeVolume"""
        _ifcopenshell_wrapper.MakeVolume_swiginit(self, _ifcopenshell_wrapper.new_MakeVolume())
    __swig_destroy__ = _ifcopenshell_wrapper.delete_MakeVolume

# Register MakeVolume in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.MakeVolume_swigregister(MakeVolume)
...
class loop(object):
    ...
    function_item = property(_ifcopenshell_wrapper.loop_function_item_get, _ifcopenshell_wrapper.loop_function_item_set, doc=r"""function_item : boost::optional<(ifcopenshell::geometry::taxonomy::function_item::ptr)>""")
    tags = property(_ifcopenshell_wrapper.loop_tags_get, _ifcopenshell_wrapper.loop_tags_set, doc=r"""tags : boost::optional<(std::vector<(std::string,std::allocator<(std::string)>)>)>""")
...
class JsonSerializer(object):
    r"""Proxy of C++ JsonSerializer class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    JSON_DIALECT_CREOOX = _ifcopenshell_wrapper.JsonSerializer_JSON_DIALECT_CREOOX
    

    def __init__(self, *args):
        r"""__init__(JsonSerializer self, file file, std::string const & json_filename, JsonSerializer::Dialect dialect=Dialect::JSON_DIALECT_CREOOX) -> JsonSerializer"""
        _ifcopenshell_wrapper.JsonSerializer_swiginit(self, _ifcopenshell_wrapper.new_JsonSerializer(*args))
    __swig_destroy__ = _ifcopenshell_wrapper.delete_JsonSerializer

    def ready(self):
        r"""ready(JsonSerializer self) -> bool"""
        return _ifcopenshell_wrapper.JsonSerializer_ready(self)

    def writeHeader(self):
        r"""writeHeader(JsonSerializer self)"""
        return _ifcopenshell_wrapper.JsonSerializer_writeHeader(self)

    def finalize(self):
        r"""finalize(JsonSerializer self)"""
        return _ifcopenshell_wrapper.JsonSerializer_finalize(self)

    def setFile(self, arg2):
        r"""setFile(JsonSerializer self, file arg2)"""
        return _ifcopenshell_wrapper.JsonSerializer_setFile(self, arg2)

# Register JsonSerializer in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.JsonSerializer_swigregister(JsonSerializer)
